import unittest
from .. import erl_terms


class AlchemistTests(unittest.TestCase):
    def test_basic_atom(self):
        hello = erl_terms.__encode_atom('hello')
        self.assertEqual(hello, b'd\x00\x05hello')

        self.assertEqual(erl_terms.__decode_atom(hello), "hello")
    ...
    def test_basic_boolean(self):
        ...
        self.assertEqual(erl_terms.__decode_atom(true_term), True)
        self.assertEqual(erl_terms.__decode_atom(false_term), False)
    ...
    def test_basic_int(self):
        ...
        self.assertEqual(erl_terms.__decode_int(int_1_term), 1)
        self.assertEqual(erl_terms.__decode_int(int_256_term), 256)
    ...
    def test_basic_string(self):
        ...
        self.assertEqual(erl_terms.__decode_string(h_term), "h")
        self.assertEqual(erl_terms.__decode_string(hell_word_term), "hello world!")

    def test_basic_none(self):
        none_term = erl_terms.__encode_none(None)
        self.assertEqual(none_term, b'd\x00\x03nil')

        self.assertEqual(erl_terms.__decode_atom(none_term), None)
    ...
    def test_list(self):
        ...
        self.assertEqual(erl_terms.__decode_list(empty_list_term), [])
        self.assertEqual(erl_terms.__decode_list(one_item_string_list_term), ['a'])
        self.assertEqual(erl_terms.__decode_list(one_item_int_list_term), [1])
        self.assertEqual(erl_terms.__decode_list(mix_list_term), [1, 'a'])
    ...
    def test_map(self):
        ...
        self.assertEqual(erl_terms.__decode_map(empty_map_term), {})
        self.assertEqual(erl_terms.__decode_map(foo_map_term), {'foo': 1})
        self.assertEqual(erl_terms.__decode_map(foo_bar_map_term), {'foo': 'bar'})
        self.assertEqual(erl_terms.__decode_map(inner_map_term), {'foo': {'bar': 4938}})
        self.assertEqual(erl_terms.__decode_map(inner_list_map_term), {'foo': {'list': [4938]}})
        ...
        self.assertEqual(erl_terms.__decode_map(erl_terms.__encode_map(complex_map)), complex_map)
